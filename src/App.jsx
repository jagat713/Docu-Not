...
const editNote = (index) => {
  ...
  return (
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 min-h-fit min-w-auto items-center gap-2 grid-wrap overflow-hidden'>
      ...
      <div className='text-white bg-gray-950 min-w-1/2 min-h-screen border-2 rounded-2xl border-gray-700 p-4 flex flex-col gap-4'>
        <h1 className='text-white text-center italic font-bold'>Your Notes</h1>
        <div className=' bg-gray-950 grid grid-cols-1 gap-1 p-2 overflow-y-auto'>
          {note.map((n, index) => (
